    ...
    public partial class Commands
    {
        ...
        public void HybridMeshCommand()
        {
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                ...
                // Старые маркеры стираются при каждом запуске: после перестройки
                // сетки они относятся к прошлой. ПЛОХИЕ — наследие убранной
                // команды MESHQUALITY, вычищаем со старых чертежей
