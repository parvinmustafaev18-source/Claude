...
namespace MeshPlugin
{
    ...
    //
    // Раньше LIRBUILD делал всё сразу: спрашивал пользователя, читал чертёж,
    ...
    // подряд на выдуманных планах — на этом стоит самотест (MPTEST).
    ...
    public partial class Commands
    {
        ...
        // те же, что были внутри LIRBUILD; перенос сделан без изменения логики.
